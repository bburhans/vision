/*****************************************************************************
FILE        : MailFlux.cpp
LAST REVISED: 2009-03-10
SUBJECT     : Main program for the MailFlux project.
AUTHOR      : (C) Copyright 2009 by Peter C. Chapin

This program is a simple SMTP server. It is intended to primarly support debugging and
 ...
 * of this function occuring at the same time.
 */
...
void *accept_loop(void *arg)
{
    ...
    while (1) {
        ...
        pthread_create(&connection_thread, NULL, connection_processor, i_arg);
...
int main(int argc, char **argv)
{
    ...
    try {
        ...
        pthread_create(&accept_thread, NULL, accept_loop, &listen_handle);

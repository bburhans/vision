...
Implementation of the server connection class.
...
namespace {
    ...
    public:
        BadClientSMTP(const string &message) : runtime_error(message) { }
    };
...
void ServerConnection::doSMTP()
{
    ...
    while (current_state != DONE) {
        ...
        case WEHLO     : doWEHLO(from_sender);      break;
        case WMAIL     : doWMAIL(from_sender);      break;
        case WRCPT1    : doWRCPT1(from_sender);     break;
        case WRCPT2    : doWRCPT2(from_sender);     break;
        case GETMESSAGE: doGETMESSAGE(from_sender); break;
        case WQUIT     : doWQUIT(from_sender);      break;
        case DONE      :                            break;
        }
    }
}
